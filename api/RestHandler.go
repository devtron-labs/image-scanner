...
func (impl *RestHandlerImpl) ScanForVulnerabilityEvent(scanConfig *common.ImageScanEvent) (*common.ScanEventResponse, error) {
	...
	impl.logger.Infow("image scan req", "ciProjectDetails", scanConfig.CiProjectDetails,
		"image", scanConfig.Image, "imageDigest", scanConfig.ImageDigest, "ciWorkflowId", scanConfig.CiWorkflowId,
		"cdWorkflowId", scanConfig.CdWorkflowId, "sourceType", scanConfig.SourceType, "sourceSubType", scanConfig.SourceSubType,
		"chartHistoryId", scanConfig.ChartHistoryId)
