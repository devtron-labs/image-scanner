...
type ImageScanService interface {
	CreateScanExecutionRegistryForClairV4(vs []*claircore.Vulnerability, event *common.ScanEvent) ([]*claircore.Vulnerability, error)
	CreateScanExecutionRegistryForClairV2(vs []*clair.Vulnerability, event *common.ScanEvent) ([]*clair.Vulnerability, error)
...
func (impl *ImageScanServiceImpl) CreateScanExecutionRegistryForClairV4(vulnerabilities []*claircore.Vulnerability, event *common.ScanEvent) ([]*claircore.Vulnerability, error) {
...
func (impl *ImageScanServiceImpl) CreateScanExecutionRegistryForClairV2(vs []*clair.Vulnerability, event *common.ScanEvent) ([]*clair.Vulnerability, error) {
