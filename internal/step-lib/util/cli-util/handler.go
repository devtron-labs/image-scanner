...
func HandleCliRequest(baseCommand, outputFileName string, ctx context.Context, outputType CliOutputType, args map[string]string, proxyEnv []string) (output []byte, err error) {
